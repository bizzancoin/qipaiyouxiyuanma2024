<template>
  <div class="app-container calendar-list-container">
    ...
    @selection-change="handleSelectionChange">
        ...
        <el-table-column label="下注数" width="250">
            <template slot-scope="scope">
...
import {
  ...
  changeRoomStatus,
  delGameRoom
} from "@/api/games/bairen_niuniuroom";
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        betOptions: [
          {  type: 'array', required: true, len:8, message: "请输入下注数(8个选项)", trigger: "change" }
        ],
        upper: [
          {
            type: "number",
    ...
    handleInputConfirm() {
      ...
      if (inputBetValue) {
        this.addForm.betOptions.push(inputBetValue);
         ...
         this.addForm.betOptions.sort((a, b) => {
            return a > b;
          });
      }
