  ...
  <div class="app-container calendar-list-container" v-loading="loading">
    ...
    <div class="filter-container" style="margin-top:20px">
        <span v-if="roomId">
          ...
          <!-- <el-button size="small" type="primary" @click="handleAddPrizePool(false)">新增金币奖池</el-button> -->
    ...
    <el-table :key="strategyKey" size="mini" :data="curPrizePool.strategys" border fit style="width:100%;margin-top:30px;">
      ...
      <el-table-column align="center" prop="control.tieRito" label="开和概率" width="100">
        <template slot-scope="scope">
          {{scope.row.control.tieRito}}%
        </template>
      </el-table-column>
    ...
    <el-dialog :title="addStrategy.title" :visible.sync="addStrategy.visible">
      <el-form :model="addStrategy.strategy" :rules="addStrategyRules" ref="addStrategyForm" label-width="280px" class="number-hide">
        ...
        <el-form-item label="开和概率" prop="tieRito">
          <el-input size="small" style="width:160px" v-model.number="addStrategy.strategy.tieRito" 
            type="number" min="0" max="100" clearable/>
          <span style="margin-left:5px">%</span>
        </el-form-item>
        <el-form-item style="margin-top:40px">
...
export default {
      ...
      addStrategy: {
        ...
        init_1: function(strategy) {
          ...
          if (strategy) {
            ...
            this.strategy.tieRito = strategy.control.tieRito;
          }
        }
      },
      addStrategyRules: {
  ...
  methods: {
    ...
    _handleDefPrizePoolStrategy(isEdit, func) {
      ...
      this.addStrategy.strategy.control.tieRito = this.addStrategy.strategy.tieRito;
      if (isEdit) {
        modDefPrizePoolStrategy(
          this.gameId,
          this.roomId,
